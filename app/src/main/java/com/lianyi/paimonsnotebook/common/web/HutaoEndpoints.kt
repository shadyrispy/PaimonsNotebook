...
object HutaoEndpoints {
    ...
    private const val Host = "api.snaphutaorp.org"
    ...
    /// </summary>
    /// <returns>路径</returns>
    fun metadataTemplate(): String = "${HutaoMetadataBaseUrl}/metadata/template"
